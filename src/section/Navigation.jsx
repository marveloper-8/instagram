...
const Navigation = (e) => {
  ...
  return (
    <div class="navigation bg-white">
      <section class="navigation-inner">

        <div>
          <img src={logo} alt="Instagram Logo" class="logo" />
        </div>
        <div
          class={search || searchValue ? "input input-active bg-1" : "input bg-1"}
        >
          <img src={searchIcon} alt="search" />
          <span class="color-2">Search</span>
          <input
            type="text"
            placeholder="Search"
